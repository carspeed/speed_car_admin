  ...
  <el-container direction="vertical" >
    ...
    <el-main style="background: white">
      <el-table :data="tableData" border>
        ...
        <el-table-column prop="sellerName" width="100" label="销售员" align="center"></el-table-column>
        ...
        <el-table-column prop="orderMoneyImg" label="定金图片" width="60" align="center">
          <template slot-scope="scope">
              <el-image
                class="table-td-thumb"
                :src="scope.row.orderMoneyImg"
                :preview-src-list="[scope.row.orderMoneyImg]"
            ></el-image>
          </template>
        </el-table-column>

        <el-table-column prop="totalMoneyImg" label="尾款图片" width="60" align="center">
          <template slot-scope="scope">
              <el-image
                class="table-td-thumb"
                :src="scope.row.totalMoneyImg"
                :preview-src-list="[scope.row.totalMoneyImg]"
            ></el-image>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="carTime" label="预计提车时间" width="160" align="center"></el-table-column>
        <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <el-button
            size="small"
            type="primary"
            @click="handleEdit(scope.$index, scope.row)" :disabled="scope.row.status != 3 || scope.row.totalMoneyImg == null ">交易完成
          </el-button>
          <el-button
            size="small"
            type="danger"
